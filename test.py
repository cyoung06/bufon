...
class MyUI(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        team_font = wx.Font(50, wx.FONTFAMILY_SWISS, wx.NORMAL, wx.FONTWEIGHT_BOLD)
        team_font2 = wx.Font(50, wx.FONTFAMILY_SWISS, wx.NORMAL, wx.FONTWEIGHT_BOLD)

        self.left_team_text = wx.StaticText(self.main_screen_panel, label="세마고 대테러 특수부대", size=(-1, -1))
        self.right_team_text = wx.StaticText(self.main_screen_panel, label="   세마고 테러리스트   ", size=(-1, -1))
